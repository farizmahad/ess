                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" align="center" class="specbundle"><div class="contentEditableContainer contentTextEditable">
                                                                                <div class="contentEditable">
                                                                                    <p style='text-align:center;margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#222222;'><span class="specbundle2"><span class="font1"><?php echo $no_pengajuan; ?></span></span></p>
                                                                                </div>
                                                                            </div></td>
                                                                        <td valign="top" class="specbundle"><div class="contentEditableContainer contentTextEditable">
                                                                                <div class="contentEditable">
                                                                                    <p style='text-align:center;margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#69C374;'><span class="font">Menunggu Permintaan Persetujuan</span> </p>
                                                                                </div>
                                                                            </div></td>
                                                                    </tr>
                                                                    </tbody>
                                                            ...
                                                            <td align='left'>
                                                                <div class="contentEditableContainer contentTextEditable">
                                                                    <div class="contentEditable" align='center'>
                                                                        <p>
<?php echo $pen->first_name; ?> <?php echo ""; ?>  <?php echo $pen->last_name; ?> telah mengirimkan permintaan persetujuan kepada anda pada tanggal

                                                                            <?php echo date('d F Y', strtotime($pen->tanggal_pengajuan)); ?>
                                                                            <br>
                                                                            <br>
                                                                        ...
                                                                        <h4>Detail Barang</h4>
                                                                         <table>
                                                                             ...
                                                                             <tr>
                                                                                 ...
                                                                                 <td><?php echo $min->harga; ?></td>
                                                                                 <td><?php echo $min->tharga; ?></td>
                                                                                 <td><?php echo $min->keterangan; ?></td>
                                                                             </tr>
                                                                             <?php endforeach; ?>
                                                                             </tbody>
                                                                         </table>
                                                                ...
                                                                <table>
                                                                    <tr>
                                                                        <td align='center' bgcolor='#1A54BA' style='background:#69C374; padding:15px 18px;-webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px;'>
                                                                            <div class="contentEditableContainer contentTextEditable">
                                                                                <div class="contentEditable">
                                                                                    <a href='<?php echo base_url(); ?>Manager/approve_pengajuan_email?status_approval=1&email=<?php echo $email; ?>&id_pengajuan=<?php echo $id_pengajuan; ?>&id_pengirim=<?php echo $id_pengirim; ?>' class='link2' style='color:#ffffff;'>Disetujui</a>
                                                                        ...
                                                                        <td align='center' bgcolor='#DC143C' style='background:#69C374; padding:15px 18px;-webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px;'>
                                                                            <div class="contentEditableContainer contentTextEditable">
                                                                                <div class="contentEditable">
                                                                                    <a href='<?php echo base_url(); ?>Manager/approve_pengajuan_email?status_approval=2&email=<?php echo $email; ?>&id_pengajuan=<?php echo $id_pengajuan; ?>&id_pengirim=<?php echo $id_pengirim; ?>' class='link2' style='color:#ffffff;'>Ditolak</a>
                                                                        ...
                                                                        <td align='center' bgcolor='#B8860B' style='background:#69C374; padding:15px 18px;-webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px;'>
                                                                            <div class="contentEditableContainer contentTextEditable">
                                                                                <div class="contentEditable">
                                                                                    <a href='<?php echo base_url(); ?>Manager/approve_pengajuan_email?status_approval=3&email=<?php echo $email; ?>&id_pengajuan=<?php echo $id_pengajuan; ?>&id_pengirim=<?php echo $id_pengirim; ?>' class='link2' style='color:#ffffff;'>Dikembalikan dengan revisi</a>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
