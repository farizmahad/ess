                                                            ...
                                                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td valign="top" class="specbundle"><div class="contentEditableContainer contentTextEditable">
                                                                                <div class="contentEditable">
                                                                                    <p style='text-align:center;margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#69C374;'><span class="font">Email baru masuk</span> </p>
                                                                                </div>
                                                                            </div></td>
                                                                    </tr>
                                                                    </tbody>
                                                            ...
                                                            <td align='left'>
                                                                <div class="contentEditableContainer contentTextEditable">
                                                                    <div class="contentEditable" align='center'>
                                                                        <p>
<?php echo $first_name; ?> <?php echo  " "; ?> <?php echo $last_name; ?> mengirim email baru kepada anda
                                                                            <br>
                                                                            <br>
                                                                ...
                                                                <table>
                                                                    <tr>
                                                                        <td align='center' bgcolor='#1A54BA' style='background:#69C374; padding:15px 18px;-webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px;'>
                                                                            <div class="contentEditableContainer contentTextEditable">
                                                                                <div class="contentEditable" align='center'>
                                                                                    <a target='_blank' href='<?php echo base_url(); ?>' class='link2' style='color:#ffffff;'>Lihat Selengkapnya</a>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
