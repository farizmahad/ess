                                            ...
                                            <td align="center">
                                                <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            <br>
                                                            <b>ANDA TELAH MELAKUKAN PERSETUJUAN NO PENGAJUAN <?php echo $no_pengajuan; ?> DENGAN STATUS
                                                                <br>
                                                                <h1>
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            Status Permintaan dengan no <?php echo $no_pengajuan; ?> saat ini adalah
                                                            <br>
                                                            ...
                                                            <?php if($last_status==0 and $id_user_approval==0 and $status_user==0 and $ket=='Manajer'){ ?>
                                                                ...
                                                                <table border="0" cellspacing="0" cellpadding="0">
                                                                    ...
                                                                    <tr>
                                                                        <td align="center">
                                                                            <br>
                                                                            Artinya, saat ini permintaan dengan no <?php echo $no_pengajuan; ?> sedang dalam tahap menunggu persetujuan manajer.
                                                                        </td>
                                                                    </tr>
                                                                </table>
