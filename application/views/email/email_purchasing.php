...
<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#eeeeee">
    <div class="Gmail" style="height: 0px !important; margin-top: -0px !important; max-width: 600px !important; min-width: 600px !important; width: 600px !important;"></div>
                                                    ...
                                                    <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                                                        ...
                                                        <tr>
                                                            <td align="center" class="hund ripplelink" width="600">
                                                                <img align="center" src="http://bursasajadah.com/assets/images/heade-email-2.jpg" width="600" style="border-radius: 3px 3px 0px 0px; width: 100%; max-width: 600px!important" class="hund">
                                                            </td>
                                                        </tr>
                                                        <!-- END HEADER IMAGE -->
                                                        <!-- START BODY COPY -->
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                <br>
                                                                <b>PERMINTAAN <?php echo $no_pengajuan; ?> TELAH
                                                                    <?php
                                                                    if($last_status==1){

                                                                        echo "DiSETUJUI";
                                                                    }elseif($last_status==2){
                                                                        echo "DITOLAK";
                                                                    }elseif($last_status==3){
                                                                        echo "DIKEMBALIKAN DENGAN REVISI";
                                                                    }

                                                                    ?>

                                                                    <?php echo strtoupper($ket); ?> YAITU <?php echo strtoupper($first_name_manajer); ?> <?php echo strtoupper($last_name_manajer); ?></b></td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <br>
                                                                ...
                                                                <table>
                                                                    <tr>
                                                                        <td align='center' bgcolor='#1A54BA' style='background:#69C374; padding:15px 18px;-webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px;'>
                                                                            <div class="contentEditableContainer contentTextEditable">
                                                                                <div class="contentEditable">
                                                                                    <a href='<?php echo base_url(); ?>Purchasing/approve_pengajuan_email?status_approval=1&email=<?php echo $email; ?>&id_pengajuan=<?php echo $id_pengajuan; ?>&id_pengirim=<?php echo $id_pengirim; ?>' class='link2' style='color:#ffffff;'>Disetujui</a>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td align='center' bgcolor='#DC143C' style='background:#69C374; padding:15px 18px;-webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px;'>
                                                                            <div class="contentEditableContainer contentTextEditable">
                                                                                <div class="contentEditable">
                                                                                    <a href='<?php echo base_url(); ?>Purchasing/approve_pengajuan_email?status_approval=2&email=<?php echo $email; ?>&id_pengajuan=<?php echo $id_pengajuan; ?>&id_pengirim=<?php echo $id_pengirim; ?>' class='link2' style='color:#ffffff;'>Ditolak</a>
                                                                        ...
                                                                        <td align='center' bgcolor='#B8860B' style='background:#69C374; padding:15px 18px;-webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px;'>
                                                                            <div class="contentEditableContainer contentTextEditable">
                                                                                <div class="contentEditable">
                                                                                    <a href='<?php echo base_url(); ?>Purchasing/approve_pengajuan_email?status_approval=3&email=<?php echo $email; ?>&id_pengajuan=<?php echo $id_pengajuan; ?>&id_pengirim=<?php echo $id_pengirim; ?>' class='link2' style='color:#ffffff;'>Dikembalikan dengan revisi</a>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
