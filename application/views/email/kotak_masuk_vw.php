    ...
    <div class="row">
                ...
                <div class="ibox-content mailbox-content">
                    <div class="file-manager">
                        ...
                        <ul class="folder-list m-b-md" style="padding: 0">
                            ...
                            <li><a href="<?php echo base_url(); ?>kotak-masuk"> <i class="fa fa-inbox "></i> Kotak masuk <span class="label label-warning pull-right"><?php echo $total_email_masuk; ?></span> </a></li>
        ...
        <div class="col-lg-9 animated fadeInRight">
            <div class="mail-box-header">
                ...
                <form method="get" action="<?php echo base_url(); ?>kotak-masuk" class="pull-right mail-search">
                    <div class="input-group">
                        <input type="email" class="form-control input-sm" name="search" placeholder="Cari berdasarkan email pengirim">
                ...
                <h2>
                    Kotak masuk (<?php echo $total_email_masuk; ?>)
                </h2>
                <div class="mail-tools tooltip-demo m-t-md">
                    ...
                    <button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left" title="Refresh inbox"><i class="fa fa-refresh"></i><a href="<?php echo base_url(); ?>kotak-masuk"> Refresh</a></button>
            ...
            <div class="mail-box">
                ...
                <table class="table table-hover table-mail">
                    ...
                    $jumlah_email_masuk=count($email_masuk);
                    if($jumlah_email_masuk > 0) {
                    ?>
                    <tbody>
                    <?php foreach($email_masuk as $mas) :?>
                        ...
                        <td class="text-right mail-date"><?php echo  date('d F Y', strtotime($mas->tanggal)); ?></td>
                    </tr>

                    <?php endforeach;?>
                    <?php }else{ ?>

<td align="center" colspan="4">Tidak ada email!</td>
                    <?php } ?>
                    </tbody>
                </table>
