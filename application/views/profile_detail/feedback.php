...
<html lang="en">
  <head>
    ...
    <title>Feedback | ESS PT. Aartijaya</title>
            ...
            <div class="row">
				...
				<div class="col-md-9">
					<ul class="list-inline profile-menu">
					 <li><a href="<?php echo site_url('feedback/'.$pek->id);?>" class="active">Saran</a></li>
					<?php

					$group_gm = array('manager');
					$id_user=$pek->id;
					if ($this->ion_auth->in_group($group_gm,$id_user)){ ?>
						...
						<nav class="navbar navbar-default">
						  <div class="container-fluid">
							...
							<ul class="nav navbar-nav">
								<li class="active"><a href="<?php echo site_url('feedback/'.$pek->id);?>" class="active"><strong>Saran</strong></a></li>
								<?php
					...
					<table class="table table-bordered" id="example2" width="100%">
					  ...
					  <tbody>
						...
						<tr>
						  ...
						  <td>
							<a href="#myModalBerat1" data-toggle="modal" data-id="<?php echo $feed->id_detail_feed_back; ?>" 
						  ...
						  <td>  
						   <a href="#myModalBerat1" data-toggle="modal" data-id="<?php echo $feed->id_detail_feed_back; ?>" 
							...
							$sub_kelebihan=substr($feed->kelebihan,0,10);

							echo "<strong>Kelebihan :</strong><br>" ;echo $sub_kelebihan; ?><br/>
								<?php
								$sub_kekurangan=substr($feed->kekurangan,0,10);
								echo "<strong>Kekurangan :</strong><br>"; echo $sub_kekurangan; ?> .. <br><br><b>selengkapnya</b>
							  </a>
						  </td>    
						</tr>
 ...
 <div class="modal fade" id="SendModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="myform" onSubmit="return validasi()" method="post" action="<?php echo base_url();?>Profile_Detail/save_feedback_question" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                        <label>Penilaian terhadap</label>
        ...
        if (editor3==null || editor3=="")
          {
           swal({
                title: "Peringatan!",
                text: "Question tidak boleh kosong!"
            });
          return false;
          };
