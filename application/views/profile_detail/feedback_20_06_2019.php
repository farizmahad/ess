            ...
            <div class="col-md-3">
              ...
              <div class="col-md-9">
                <ul class="list-inline profile-menu">
                  <li><a href="<?php echo site_url('feed/'.$pek->id);?>" class="active">Saran</a></li>
                <?php
                /*
                ...
                if ($this->ion_auth->in_group($group_gm)){ */?>
                   <li><a href="<?php echo site_url('kirim-pertanyaan/'.$pek->id);?>">History Pertanyaan</a></li>
                    <li><a href="<?php echo site_url('pertanyaan-terima/'.$pek->id);?>">Pertanyaan terima</a></li
                <?php/* } */?>
                </ul>
