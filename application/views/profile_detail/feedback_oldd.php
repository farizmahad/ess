            ...
            <div class="col-md-3">
              ...
              <div class="col-md-9">
                <ul class="list-inline profile-menu">
                  <li><a href="<?php echo site_url('feed/'.$pek->id);?>">Feed Received</a></li>
                <?php
                $group_gm = array('manager');
                if ($this->ion_auth->in_group($group_gm)){ ?>
                   <li><a href="<?php echo site_url('kirim-pertanyaan/'.$pek->id);?>" class="active">Pertanyaan</a></li>
                <?php } ?>
                </ul>
                ...
                <table class="table table-bordered" id="example2" width="100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo date_indo($feed->date); ?></td>
                      <td>
