            ...
            <div class="row">
				...
				<div class="col-md-9">
					<ul class="list-inline profile-menu">
					  ...
					  <li><a href="<?php echo site_url('tujuan-individu-tutup/'.$pek->id);?>" class="active">Capaian Individu (Selesai)</a></li>
					  <li><a href="<?php echo site_url('penerima-poin-pengembangan/'.$pek->id);?>">Poin Pengembangan (diterima)</a></li>
					  <!--
					  <li><a href="timeline-friends.html">Development Planss</a></li>
        ...
        <div id="page-contents">
          <div class="row">
            ...
            <div class="col-md-9">
						...
						<nav class="navbar navbar-default hidden-sm hidden-xs">
						  <div class="container-fluid">
							...
							<ul class="nav navbar-nav">
								...
								<li class="active"><a href="<?php echo site_url('tujuan-individu-tutup/'.$pek->id);?>"><strong>Capaian Individu (Selesai)</strong></a></li>
								<?php } ?>
								<?php if($id_login==$id_data){ ?>
								<li><a href="<?php echo site_url('penerima-poin-pengembangan/'.$pek->id);?>">Poin Pengembangan (diterima)</a></li>
								<?php } ?>
			  ...
			  <div  class="row">
                  <h4><b>Capaian Individu (Selesai)</b></h4><br>
                ...
                <table class="table table-striped table-hover table-bordered" id="example2" width="100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <?php echo $go->category_goal; ?>
                      </td>
                    
                      <td align="center">
                          <a data-toggle="tab"  id="<?php echo $go->id_goal; ?>" class="client-link" onClick="reply_click_feed(this.id)" style="cursor: pointer;">Detail</a>
                      </td>
                    </tr>
