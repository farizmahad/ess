            ...
            <div class="col-md-3">
              ...
              <div class="col-md-9">
                ...
                <?php if($id_login==$id_penerima_user) { ?>
                  ...
                  <?php if($id_login==$id_penerima_user) { ?>
               <li><a href="<?php echo site_url('riwayat-kirim-saran/'.$pek->id);?>" class="active">Riwayat Kirim Saran</a></li>
             <?php } ?>
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="myform" onSubmit="return validasi()" method="post" action="<?php echo base_url();?>Profile_Detail/kirim_saran" enctype="multipart/form-data">
                  
                        <?php
                        $tanggal=date('Y-m-d');
                         ?>
                        <input type="text" name="id_pembuat" class="form-control id_pembuat">
