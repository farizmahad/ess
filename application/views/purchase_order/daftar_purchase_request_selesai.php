...
<div class="col-lg-9">
 <h4 class="grey"><i class="icon ion-ios-bookmarks" style="color:#0000ff;"></i> Daftar Purchase Request selesai</h4>
        <div class="line"></div>
           <form action="<?php echo base_url(); ?>User_pengajuan/cari_purchase_request" method="get">
                            ...
                            <div class="input-group">
                              ...
                              <div class="ddl-select input-group-btn">
                                <select id="ddlsearch" class="selectpicker form-control" data-style="btn-success" name="select">
                                  ...
                                  <option value="no_purchase_request">No Purchase Request</option>
                          ...
                          <a href="<?php echo base_url(); ?>User_pengajuan/export_purchase_request_selesai?pilih_tanggal="<?php echo $pilih_tanggal; ?>&select="<?php echo $select; ?>&search="<?php echo $search; ?>" class="btn btn-sm btn-success">Unduh </a>
                          <div class="line"></div>
                ...
                <table class="table table-striped table-hover table table-responsive-lg" id="example2">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <?php echo date_indo($pur->tanggal_pengajuan); ?>
                        </td>
                        <td align="center">
