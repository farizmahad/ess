  ...
  <body>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right main-menu">
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Beranda <span><img src="images/down-arrow.png" alt="" /></span></a>
              ...
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Kotak Masuk <span><img src="images/down-arrow.png" alt="" /></span></a>
            ...
            <form class="navbar-form navbar-right hidden-sm">
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Cari Request...">
              </div>
            </form>
          </div><!-- /.navbar-collapse -->
        </div><!-- /.container -->
    ...
    <div id="page-contents">
    	<div class="container">
          ...
          ================================================= -->
          <!-- Masukan Side Bar Kiri di sini -->			
          <div class="col-md-3 static">
            <div class="profile-card">
            	<img src="http://placehold.it/300x300" alt="user" class="profile-photo" />
            	<h5><a href="timeline.html" class="text-white">Ahmad Fariz</a></h5>
            	<!--<a href="#" class="text-white"><i class="ion ion-android-person-add"></i> 1,299 followers</a>-->
            	<a href="#" class="text-white"><i class="ion ion-android-person-add"></i> 25 Request</a>
            </div><!--profile card ends-->
            <ul class="nav-news-feed">
              <li><i class="icon ion-ios-paper"></i><div><a href="newsfeed.html">Halama Utama</a></div></li>
              <li><i class="icon ion-ios-people"></i><div><a href="newsfeed-people-nearby.html">Tambah Permintaan</a></div></li>
              <li><i class="icon ion-ios-people-outline"></i><div><a href="newsfeed-friends.html">Daftar Permintaan</a></div></li>
            ...
            <div class="post-content">
              ...
              <div class="post-container">
                <h2> Edit Permintaan </h2>
                <div class="row">
                    <div class="form-group col-xs-12">
                        <label for="firstname"> Nomor Permintaan</label>
                        <input id="firstname" class="form-control input-group-lg" type="text" name="firstname" title="Enter first name" placeholder="First name" value="Nomor Permintaan" readonly=""/>
                      </div>
                      <div class="form-group col-xs-12">
                        <label for="lastname" class="">Tanggal Permintaan</label>
                        <input id="lastname" class="form-control input-group-lg" type="text" name="lastname" title="Enter last name" placeholder="Last name" value="Tanggal Permintaan" readonly=""/>
                      </div>
                        <div class="form-group col-xs-12">
                        <label for="firstname"> Tanggal Dibutuhkan</label>
                        <input id="firstname" class="form-control input-group-lg" type="date" name="firstname" title="Enter first name" placeholder="First name" value="Tanggal Dibutuhkan" />
                      </div>
                    <div class="form-group col-xs-12">
                        <label for="lastname">Jenis Permintaan</label>
                        <select class="form-control" id="exampleFormControlSelect1">
                            <option selected> Pilih Jenis Permintaan </option>
